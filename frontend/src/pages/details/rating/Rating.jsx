...
const Rating = () => {
  ...
  const profiles = [
    ...
    },
    {
      icon: "profile.png",
      name: "Jane Smith",
      comment: "This is a comment by Jane Smith.",
    },
    {
      icon: "profile.png",
      name: "Alice Johnson",
      comment: "This is a comment by Alice Johnson.",
    },
    {
      icon: "profile.png",
      name: "Michael Brown",
      comment: "This is a comment by Michael Brown.",
    },
    {
      icon: "profile.png",
      name: "Emily Davis",
      comment: "This is a comment by Emily Davis.",
    },
    {
      icon: "profile.png",
      name: "Chris Wilson",
      comment: "This is a comment by Chris Wilson.",
    },
    {
      icon: "profile.png",
      name: "David Lee",
      comment: "This is a comment by David Lee.",
    },
    {
      icon: "profile.png",
      name: "Sarah Green",
      comment: "This is a comment by Sarah Green.",
    },
    {
      icon: "profile.png",
      name: "Paul King",
      comment: "This is a comment by Paul King.",
    },
    {
      icon: "profile.png",
      name: "Laura Adams",
      comment: "This is a comment by Laura Adams.",
    },
  ];
    ...
    <div className="two-containers">
      ...
      <div
        className={`container right-container ${
          dropdownVisible.right ? "expanded" : ""
        }`}
      >
